      ...
      >
        ...
        <CardActionArea>
          ...
          >
            ...
            <Typography gutterBottom variant="h5" component="h2" fontFamily="Montserrat">
              {title}
            </Typography>
            <Typography
              gutterBottom
            ...
            >
              <Stack direction="row" alignItems={"flex-end"}>
                ...
                <Typography component="p" fontSize={10} color="grey" fontFamily="Montserrat"> 
                  &nbsp; ETH funded
                </Typography>
              </Stack>
              <Stack direction="row" alignItems={"flex-end"}>
            ...
            <Stack direction="row" alignItems={"center"}>
              ...
              <Typography gutterBottom fontSize={14} color="grey" fontFamily="Montserrat">
                &nbsp; {daysLeft} days left
              </Typography>
            </Stack>
          </CardContent>
